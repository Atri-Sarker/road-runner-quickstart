...
public class RobotFieldPosesBlue {
    ...
    public double directionFacingRamp = Math.toRadians(180);
    ...
    public double ArtifactSetStart_X = -13;
    ...
    public Pose2d PGPStart = new Pose2d(ArtifactSetStart_X, 0, directionFacingRamp);
