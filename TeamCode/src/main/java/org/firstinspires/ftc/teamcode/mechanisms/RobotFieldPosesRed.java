...
public class RobotFieldPosesRed {
    ...
    public double directionFacingRamp = Math.toRadians(358);

    public double directionFacingGoal = Math.toRadians(45);

    // Starting Position
    public Pose2d initialGoalPose = new Pose2d(48, 48, directionFacingGoal);

    public Pose2d initialFarPose = new Pose2d(15, -64, directionUP);

    public Pose2d startPoseClose = new Pose2d(15, 15, directionUP);
    public Pose2d startPoseLong = new Pose2d(15, -65, directionUP);

    // Shooting Positions
    public  Pose2d shootPoseLong = new Pose2d(15, -60, directionFacingGoal);
    public Pose2d shootPoseMedium = new Pose2d(-48, 48, directionFacingGoal);
    public Pose2d shootPoseClose = new Pose2d(16, 16, directionFacingGoal);


    // X Value for the start of artifact sets
    public double ArtifactSetStart_X = 16;
    // X Value for the end of artifact sets
    public double ArtifactSetEnd_X = 48;
